...
class Personnel(Base, TimestampMixin):
    ...
    mm_start_date: Mapped[date | None] = mapped_column(Date)
    mm_end_date: Mapped[date | None] = mapped_column(Date)
    yearly_mm: Mapped[float | None] = mapped_column(Numeric(8, 2))
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class Project(Base, TimestampMixin):
    ...
    delivery_pm_name: Mapped[str | None] = mapped_column(String(100))
